...
### 6. تصميم `og-image.png` (صورة المشاركة) 🟡 اختياري — الـ placeholder يعمل الآن
| | |
|--|--|
| **المشكلة** | الموقع يستخدم `og-image.svg` — فيسبوك/تويتر/واتساب لا يقبلان SVG → المشاركة تظهر بدون صورة |
| **المطلوب** | صورة PNG بحجم **1200 × 630 بكسل** |
| **المحتوى المقترح** | شعار Atlas News + خلفية داكنة + "World News in 5 Languages" |
| **أدوات مجانية** | Canva.com → Custom size 1200×630 → تحميل PNG |
| **بعد التصميم** | ضع الملف في `static/og-image.png` وأخبر شريكك ليحدث الـ `og_image_url` |
| **الوقت** | ~20 دقيقة |

---

### 13. التسجيل في Google News Publisher Center 🔴 ضروري للـ Traffic
| | |
|--|--|
| **الأثر** | بدون هذا لا يظهر الموقع في Google News → يفوتك آلاف الزيارات اليومية |
| **الرابط** | https://publishercenter.google.com |
| **الخطوات** | 1. تسجيل دخول بحساب Google → 2. Add Publication → 3. أدخل `atlasnews.solvixi.com` → 4. تحقق من الملكية (meta tag موجود بالفعل في Search Console) → 5. أرسل طلب مراجعة |
| **المتطلبات** | الموقع يحتاج: محتوى حقيقي + about page + contact page (✅ موجودان) + سياسة الخصوصية (✅ موجودة) |
| **وقت المراجعة** | 2-4 أسابيع من Google |
| **الوقت اليدوي** | ~15 دقيقة |

---

### 14. ربط Google Search Console بـ GA4
| | |
|--|--|
| **الشرط** | إنجاز المهمة 5 (GA4) أولاً |
| **الخطوات** | Google Analytics → Admin → Property Settings → Search Console → Link |
| **الفائدة** | تقارير موحدة: أداء البحث + سلوك المستخدم في مكان واحد |
| **الوقت** | ~5 دقائق |
